...
public sealed class Program : MyGridProgram {
     ...
     */
    #region RemoteMagicControl
    private IMyFunctionalBlock TargetBlock;
    /*
    ...
    public void Main(string argument, UpdateType updateSource) 
    {
        if (updateSource == UpdateType.Update100)
        {
            ...
            TargetBlock.Enabled = !TargetBlock.Enabled;
        }
        else
        {
            TargetBlock = GridTerminalSystem.GetBlockWithName(argument) as IMyFunctionalBlock;
            if (TargetBlock != null)
            {
